...
from dataloader import DataReader, DataReader_random_split
...
def train_and_eval(datadir, datname, hyperpm):
    ...
    for num, seed in enumerate(seeds):
        ...
        if datname in ['cora', 'citeseer']:
            ...
            if datname in ['computers', 'photo']:
                datname = 'amazon_electronics_' + datname
...
def main(args_str=None):
    ...
    parser.add_argument('--early', type=int, default=25,
